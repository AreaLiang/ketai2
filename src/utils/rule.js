...
const rules = {
  ...
  PassWord(str){
	const regex = /^\w{6,8}$/
	return valid(str, regex, "请输入6到16位的字符")
  },
  ...
  Phone(phone) {
    ...
    return valid(phone, regex, "格式不正确！如：0111-8137664")
  },
...
export function vxRule(required=true, type, trigger="blur", nullMsg="这是必填项，不能为空！"){
